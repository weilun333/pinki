...
CREATE TABLE `bank_account` (
  ...
  `member_type` int NOT NULL COMMENT '會員類別 (會員1 品牌2)',
  ...
  `is_usual_account` tinyint(1) NOT NULL DEFAULT '1' COMMENT '是否為常用帳號',
  `process_user` varchar(20) NOT NULL COMMENT '最後更新者',
  `last_update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最後更新時間',
  PRIMARY KEY (`account_no`)
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='銀行帳號總表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `bank_account` VALUES (23,1,2,39,'5956249565','886',NULL,1,'gsgsehs','2023-09-20 04:22:00'),(24,1,2,40,'5956249565','886',NULL,1,'gsgsehs','2023-09-20 04:27:10'),(25,1,2,41,'5956249565','886',NULL,1,'gsgsehs','2023-09-20 04:32:08'),(26,1,2,42,'5956249565','886',NULL,1,'gsgsehs','2023-09-20 04:39:33'),(27,1,2,43,'5956249565','886',NULL,1,'gsgsehs','2023-09-20 04:48:00'),(28,1,2,44,'5956249565','886',NULL,1,'gsgsehs','2023-09-20 04:56:05'),(29,1,2,45,'5956249565','886',NULL,1,'gsgsehs','2023-09-20 05:03:05'),(30,1,2,46,'5956249565','886',NULL,1,'gsgsehs','2023-09-20 05:09:11'),(31,1,2,47,'5956249565','886',NULL,1,'gsgsehs','2023-09-20 05:14:35'),(32,1,2,48,'5956249565','886',NULL,1,'gsgsehs','2023-09-20 05:15:35'),(33,1,2,49,'5956249565','886',NULL,1,'gsgsehs','2023-09-20 05:19:21');
...
CREATE TABLE `brand` (
  ...
  `designer_account` varchar(100) NOT NULL COMMENT '設計師帳號',
  `designer_password` varchar(68) NOT NULL COMMENT '設計師密碼',
  ...
  `bank_account` varchar(20) NOT NULL COMMENT '收款帳戶',
  `brand_story` varchar(500) NOT NULL COMMENT '品牌簡介',
  `brand_logo` blob COMMENT '品牌logo',
  `cover_pic` blob COMMENT '封面照片',
  `designer_status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '設計師帳號狀態',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '建立時間',
  `process_user` varchar(20) NOT NULL COMMENT '最後更新者',
  `last_update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最後更新時間',
  `role` varchar(45) NOT NULL DEFAULT 'designer' COMMENT '角色',
  PRIMARY KEY (`brand_no`)
) ENGINE=InnoDB AUTO_INCREMENT=50 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='品牌';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `brand` VALUES (46,'szgsarg','bgwag634@gmail.com','{bcrypt}$2a$10$.DXx/k5wCD5Wj5V31EqYfe/yZujR7T.HrTjlmQcBZDBuvDzox/Iwm','00004110','0229526851',NULL,'886','5956249565','vvafef',NULL,NULL,0,'2023-09-20 05:09:11','gsgsehs','2023-09-20 05:14:30','designer'),(47,'waefawf','faqef634@gmail.com','{bcrypt}$2a$10$Fx/V4uTJgyTxJCIUVJjGkuHTH6lZ9e6ipv9hrqrx6k6Oc5XH702si','00004110','0229526851',NULL,'886','5956249565','vvafef',NULL,NULL,0,'2023-09-20 05:14:35','gsgsehs','2023-09-20 05:15:30','designer'),(48,'gsgsrgqaehs','beagr590634@gmail.com','{bcrypt}$2a$10$IsDAC3Hju9AC8Rd6WjfWvuS6zHIhPK4kSJcgX.NBcdNlcYPucftBa','00004110','0229526851',NULL,'886','5956249565','vvafef',NULL,NULL,0,'2023-09-20 05:15:35','gsgsehs','2023-09-20 05:19:17','designer'),(49,'gsgsehs','be8590634@gmail.com','{bcrypt}$2a$10$BRe8Xzw33rrSeBa7Sg6YpuWfuc46N73BRPnQ6CgxsG7ZBwiPtmOHa','00004110','0229526851',NULL,'886','5956249565','vvafef',NULL,NULL,0,'2023-09-20 05:19:21','gsgsehs','2023-09-20 05:19:21','designer');
...
CREATE TABLE `member` (
  ...
  `member_password` varchar(68) NOT NULL COMMENT '會員密碼',
...
--
-- Table structure for table `prod_label`
--
...
CREATE TABLE `prod_label` (
  `prod_label_no` int NOT NULL AUTO_INCREMENT COMMENT '商品標籤編號',
  `brand_no` int NOT NULL COMMENT '品牌編號',
  `prod_label_name` varchar(50) NOT NULL COMMENT '商品標籤名稱',
  PRIMARY KEY (`prod_label_no`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='商品標籤';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `prod_label`
--

LOCK TABLES `prod_label` WRITE;
/*!40000 ALTER TABLE `prod_label` DISABLE KEYS */;
/*!40000 ALTER TABLE `prod_label` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `prod_order` (
  ...
  `member_no` int NOT NULL COMMENT '會員編號',
  `brand_no` int NOT NULL COMMENT '品牌編號',
  `order_status` int NOT NULL DEFAULT '0' COMMENT '訂單狀態 (0: 未完成 1:已完成 2:貨物已送出 3:退貨 4: 取消訂單)',
...
CREATE TABLE `prod_order_detail` (
  ...
  `prod_price` int NOT NULL COMMENT '商品價格',
  `order_status` int NOT NULL DEFAULT '0' COMMENT '訂單狀態 ',
...
CREATE TABLE `verification_token` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='註冊驗證token';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `verification_token` VALUES (1,'ae0b3aea-1168-4399-ada2-1744b50c4923',42,'2023-09-20 04:49:34'),(2,'78479b06-4e1e-4ab4-9385-f31e7c9d6e1e',43,'2023-09-20 04:58:00'),(3,'70edc554-b395-4adb-9e93-e18b09450778',44,'2023-09-20 05:06:05'),(4,'bf8503b9-202e-4808-bc55-0cf47a851c5b',45,'2023-09-20 05:13:05'),(5,'9ea804db-8f9a-488c-bf9c-16587bad778d',46,'2023-09-20 05:19:11'),(6,'91e963c5-68c9-465a-bc69-eb3aaeea1f0f',47,'2023-09-20 05:24:36'),(7,'af6649e4-95a3-4575-8a27-17195a8afac9',48,'2023-09-20 05:25:36'),(8,'4d2639c2-f042-4dd1-891f-d6746177a5bf',49,'2023-09-20 05:29:22');
...
-- Dump completed on 2023-09-23 19:25:05
